...
def prepare_swiggy_data():
    ...
    """
    # Load public MovieLens dataset (free alternative to Swiggy's data)
    ...
    # Convert movies → dishes, genres → cuisine types (Swiggy context)
    ...
    # Add Swiggy-specific cuisine mapping (proves business understanding)
    cuisine_map = {
    ...
    # Train-test split (Swiggy cares about model robustness)
...
if __name__ == "__main__":
    ...
    # Save for model training (Swiggy's "shipping to production" requirement)
